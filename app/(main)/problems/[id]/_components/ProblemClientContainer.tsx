...
const RightPart = ({ id }: { id: number }) => (
  <div className="flex-col gap-4 flex">
    <div className="p-4 flex flex-col max-w-65">
      ...
      <Link
        href={`/problems/${id}/testdata`}
        className={cn(buttonVariants({ variant: 'ghost' }), 'justify-start rouned-none')}
      >
        <Battery />
        测试数据
      </Link>
        ...
        {isEditorMode ? (
          <>
            ...
            <div className="flex-1 flex flex-col gap-2">
              <CodeOptons language={language} setLanguageAction={setLanguage} />
